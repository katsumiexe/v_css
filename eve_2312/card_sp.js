...
$(".chu_card").queue(function(next){
    $('#c3').delay(0).animate({"left":"53vw"}, 400).delay(3000).animate({"left":"5vw"}, 400).delay(100)
	...
	$('#c2').delay(100).animate({"left":"37vw"}, 400).delay(2800).animate({"left":"5vw"}, 400).delay(600)
    ...
    $('#c1').delay(200).animate({"left":"21vw"}, 400,function() {
        next();
    }).delay(2600).animate({"left":"5vw"}, 400).delay(3000).animate({"left":"21vw"}, 400);
